...
class Exportar():
    ...
    def _jsonToCsv(self, archivo):
        archivo_csv = open("generado.csv", "w")     # Creo el archivo a generar
    ...
    def _csvToJson(self, archivo):
        archivo_json = open("generado.json", "w")
...
if __name__ == "__main__":
    archivo_csv = open("csvtest.csv", "r")
    archivo_json = open("generado.json", "r")
    exp = Exportar()
